...
class TVBoxValidator:
    ...
    def validate_single_url(self, url_data: Dict) -> Tuple[Dict, bool, float, float]:
        """
        验证单个 URL
        返回：(url_data, is_valid, response_time, content_length_kb)
        """
        # 修复：参数名已改为 url_data，此处可正常使用
        url = url_data['url']
        name = url_data['name']
        ...
        try:
            ...
            if response.status_code == 200:
                ...
                if classification == 0 and content_length_kb > 2:
                    ...
                    return (url_data, True, response_time, content_length_kb)
                ...
                if response2.status_code == 200:
                    ...
                    if classification2 == 0 and content_length_kb2 > 2:
                        ...
                        return (url_data, True, response_time, content_length_kb2)
            
            logger.warning(f"✗ {name} - {url} 线路失败")
            return (url_data, False, response_time, 0)
        ...
        try:
            ...
            with ThreadPoolExecutor(max_workers=10) as executor:
                ...
                for future in as_completed(future_to_url):
                    url_data, is_valid, response_time, content_length_kb = future.result()
